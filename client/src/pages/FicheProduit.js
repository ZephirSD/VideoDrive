    ...
    <>
      ...
      <main className="padMain">
        <div className="gridInfo">
          <div className="caseTitreImage">
            ...
            <p className="paraGenre">
              <span className="libelleGenre">Genre:&nbsp;</span>
              <span className="texteGenre">
        ...
        <div className="paraDescr">
          ...
          quisquam modi voluptatem ullam minus quos! Ad, molestias fugit
          voluptas culpa tenetur omnis modi, rem labore maxime sapiente, debitis
          eius. Aperiam ipsa ipsum culpa quam sit recusandae quo ratione
